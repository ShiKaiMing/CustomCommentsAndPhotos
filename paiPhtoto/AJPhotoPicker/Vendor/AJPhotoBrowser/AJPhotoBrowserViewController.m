...
@interface AJPhotoBrowserViewController()<UIScrollViewDelegate,UIActionSheetDelegate,AJPhotoZoomingScrollViewDelegate>
{
    //data
...
- (void)initUI {
    ...
    _photoScrollView.backgroundColor = [UIColor blackColor];//UIColor.clearColor;
...
#pragma mark - AJPhotoZoomingScrollViewDelegate
